...
final primary = const Color(0xFFFE1483);
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        backgroundColor: Color(0xFF2b2d5c),
        appBar: AppBar(
          ...
          title: Text("Music Player",
              style: TextStyle(color: Color(0xFFFFFFFF), fontFamily: "Nexa")),
          centerTitle: true,
          actions: <Widget>[
            IconButton(
                          ...
                          child: Row(
                            children: <Widget>[
                              Icon(Icons.fast_rewind,
                                  size: 55.0, color: Color(0xFFFFFFFF)),
                              Expanded(
                                child: Container(),
                              ),
      ...
      children: <Widget>[
        ...
        Column(
          ...
          children: <Widget>[
            ...
            Text(subtitle, style: TextStyle(color: Color(0xFFFFFFFF)))
          ],
        )
      ],
    ),
